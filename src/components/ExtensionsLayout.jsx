...
const ExtensionsLayout = () => {
  ...
  return (
    <div>
      <div className="flex-cols justify-self-center md:flex items-center md:justify-between mb-5">
        <h1 className='text-2xl font-700 text-center md:text-left'>Extensions List</h1>
